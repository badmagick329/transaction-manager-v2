...
export type DataCoverageAccount = { accountId: number; accountName: string; currencyCode: string; sourceId: number; sourceName: string; required: boolean; earliestTransactionDate: string | null; latestTransactionDate: string | null; lastImportAt: string | null; coverageIntervals: CoverageInterval[]; manualBaseline: CoverageInterval | null };
